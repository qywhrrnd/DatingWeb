...
<body>
    ...
    <div class="container mt-5">
        <table class="table">
            <tbody>
                <c:choose>
                    <c:when test="${map.mdto.countfollowing == 0}">
                        <tr>
                            <td>
                                <h1>내가 팔로우한 사람이 없습니다!</h1>
                            </td>
                        </tr>
                    </c:when>
                                        ...
                                        <div class="d-flex align-items-center p-3">
                                            ...
                                            <div class="ml-3 w-100">
                                                ...
                                                <div class="button mt-2 d-flex flex-row align-items-center">
                                                    <a class="btn btn-sm btn-outline-primary w-100" onclick="point(${sessionScope.point}, '${sessionScope.userid}', '${row.userid}')">VIEW</a>
